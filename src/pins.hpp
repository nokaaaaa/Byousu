...
namespace DigitalOutPins
{
    ...
    constexpr PinName MOTOR3_DIR = PA_6; // モータ3の方向 2の位置うごかん
...
namespace PwmOutPins
{
    ...
    constexpr PinName MOTOR3_PWM = PA_14; // モータ3のPWM
...
{
    constexpr PinName MEASURING_ENCODER1_B = PC_1; // 測定輪エンコーダ1のB相
    constexpr PinName MEASURING_ENCODER2_B = PB_0; // 測定輪エンコーダ2のB相
}

namespace InterruptInPins
{
    constexpr PinName MEASURING_ENCODER1_A = PC_0; // 測定輪エンコーダ1のA相
    constexpr PinName MEASURING_ENCODER2_A = PA_4; // 測定輪エンコーダ2のA相
}
