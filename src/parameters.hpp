...
#define TRED_RADIUS (243.0f) //中心からオムニホイールの距離[mm]
...
#define WHEEL_ENCODER_RADIUS (60.0f)//エンコーダーの半径[mm]
...
#define DT_1_x (100.0f)//DT35_1のR2の中心を原点としたときのx座標[mm]
...
#define DT_3_x (60.0f)//DT35_3の中心を原点としたときのx座標[mm]
#define DT_3_y (-195.0f)//DT35_3の中心を原点としたときのy座標[mm]
...
#define PWM_PERIOD (20.0f) //PWMの周期[ms]
